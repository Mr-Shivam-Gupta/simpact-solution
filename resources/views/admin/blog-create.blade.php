                              ...
                              <div class="image-upload">
                                 <div class="thumb">
                                    <div class="avatar-preview">
                                       <div class="profilePicPreview" style="background-image: url(https://script.viserlab.com/bisurv/placeholder-image/700x450)">
                        ...
                        <div class=" col-md-8 ">
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 placeholder="Publish Date" autocomplete="off" readonly
                                 value="{{old('date')}}">
                                 @error('date')
                                 <div class="text-danger">{{ $message }}</div>
                              @enderror
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <textarea rows="10" class="form-control nicEdit" placeholder="Description" name="description" >{{old('description')}}</textarea>
                                 @error('description')
                                 <div class="text-danger">{{ $message }}</div>
                              @enderror
                              </div>
